...
To build the final jar and optimize the chama application for production, run:
...
Then navigate to [http://localhost:45002](http://localhost:45002) in your browser.
