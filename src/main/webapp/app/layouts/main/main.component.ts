...
export class ChamaMainComponent implements OnInit, OnDestroy {
  ...
  private getPageTitle(routeSnapshot: ActivatedRouteSnapshot) {
    let title: string = routeSnapshot.data && routeSnapshot.data['pageTitle'] ? routeSnapshot.data['pageTitle'] : 'chamaApp';
