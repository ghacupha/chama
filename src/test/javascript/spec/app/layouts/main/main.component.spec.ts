...
import { ChamaMainComponent } from 'app/layouts';
import { MockStateStorageService } from '../../../helpers/mock-state-storage.service';
import { ChamaTestModule } from '../../../test.module';

describe('Component Tests', () => {
  describe('MainComponent', () => {
    let comp: ChamaMainComponent;
    let fixture: ComponentFixture<ChamaMainComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ChamaMainComponent],
        providers: [
          {
        ...
        .overrideTemplate(ChamaMainComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(ChamaMainComponent);
