...
import { ChamaHealthCheckComponent } from 'app/admin/health/health.component';
import { ChamaHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('ChamaHealthCheckComponent', () => {
    let comp: ChamaHealthCheckComponent;
    let fixture: ComponentFixture<ChamaHealthCheckComponent>;
    let service: ChamaHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [ChamaTestModule],
        declarations: [ChamaHealthCheckComponent]
      })
        .overrideTemplate(ChamaHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(ChamaHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(ChamaHealthService);
    });
