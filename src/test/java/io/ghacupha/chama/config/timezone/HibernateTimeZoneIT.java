package io.ghacupha.chama.config.timezone;

import io.ghacupha.chama.ChamaApp;
import io.ghacupha.chama.config.TestSecurityConfiguration;
import io.ghacupha.chama.repository.timezone.DateTimeWrapper;
import io.ghacupha.chama.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM chama_date_time_wrapper where id=%d", fieldName, id);
    }
